...
content_dictionary = {
    1: {"media": "./static/UnitCircle.png",
          "question": "The sine function is:",
          "options": ["An odd function.", "An even function.", "An inverse function.", "A hyperbolic function."],
          "answer": "An odd function.",
          "explanation": "When the sign of the input changes, the sign of the output of the sine function changes.  That is, by definition, an 'odd' function."},
